...
const SPECIALTIES = ['Engine', 'Electrical', 'Bodywork', 'Transmission'];
...
export const SuggestMechanicModal: React.FC<Props> = ({
  visible,
  onClose,
  onSubmit,
}) => {
  ...
  const handleSubmit = async () => {
    if (!isValid || !specialty) return;
    try {
      setSubmitting(true);
      await onSubmit({ name, phone, location, specialty, reason });
      Toast.show({
        type: 'success',
        ...
        <View style={styles.sheet}>
          <View style={styles.header}>
            <View style={styles.headerText}>
              <Text style={styles.title}>Suggest a Mechanic</Text>
              <Text style={styles.subtitle}>
                Know a great mechanic? Help other drivers find them.
              </Text>
            </View>
          ...
          >
            <Text style={styles.label}>Mechanic / Garage Name</Text>
            <TextInput
              style={styles.input}
              value={name}
              onChangeText={setName}
              placeholder="e.g. David's Auto Garage"
