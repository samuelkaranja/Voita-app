...
const SERVICE_TYPES = ['Interior', 'Exterior', 'Full Detail'];
...
export const SuggestCarWashModal: React.FC<Props> = ({
  visible,
  onClose,
  onSubmit,
}) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      setSubmitting(true);
      await onSubmit({ name, phone, location, serviceType, reason });
      Toast.show({
        type: 'success',
        ...
        <View style={styles.sheet}>
          <View style={styles.header}>
            <View style={styles.headerText}>
              <Text style={styles.title}>Suggest a Car Wash</Text>
              <Text style={styles.subtitle}>
                Know a great car wash we're missing? Let us know and we'll
                review it.
              </Text>
            </View>
          ...
          >
            <Text style={styles.label}>Car Wash / Center Name</Text>
            <TextInput
              style={styles.input}
              value={name}
              onChangeText={setName}
              placeholder="e.g. Speed Wash Pro"
